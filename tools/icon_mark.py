#!/usr/bin/env python3
"""Build BrightTransit's launcher mark.
...
MARK = [
    ('M30,36 A12,12 0 0 1 42,24 H66 A12,12 0 0 1 78,36 V74 A4,4 0 0 1 74,78 H34 A4,4 0 0 1 30,74 Z', 5, False),
    ('M42.00,34.00 H66.00 A3.00,3.00 0 0 1 69.00,37.00 V51.00 A3.00,3.00 0 0 1 66.00,54.00 H42.00 A3.00,3.00 0 0 1 39.00,51.00 V37.00 A3.00,3.00 0 0 1 42.00,34.00 Z', 4, False),
    ('M36.50,66.00 A4.50,4.50 0 1 1 45.50,66.00 A4.50,4.50 0 1 1 36.50,66.00 Z', 0, False),
    ('M62.50,66.00 A4.50,4.50 0 1 1 71.50,66.00 A4.50,4.50 0 1 1 62.50,66.00 Z', 0, False),
]
...
RASTERS = [
    ('examples/LightNYCSubway/src/main/res/mipmap-hdpi/ic_launcher.png', 72, False, 0.72, False),
    ('examples/LightNYCSubway/src/main/res/mipmap-hdpi/ic_launcher_foreground.png', 72, False, 1.0, True),
    ('examples/LightNYCSubway/src/main/res/mipmap-hdpi/ic_launcher_round.png', 72, True, 0.72, False),
    ('examples/LightNYCSubway/src/main/res/mipmap-mdpi/ic_launcher.png', 48, False, 0.72, False),
    ('examples/LightNYCSubway/src/main/res/mipmap-mdpi/ic_launcher_foreground.png', 48, False, 1.0, True),
    ('examples/LightNYCSubway/src/main/res/mipmap-mdpi/ic_launcher_round.png', 48, True, 0.72, False),
    ('examples/LightNYCSubway/src/main/res/mipmap-xhdpi/ic_launcher.png', 96, False, 0.72, False),
    ('examples/LightNYCSubway/src/main/res/mipmap-xhdpi/ic_launcher_foreground.png', 96, False, 1.0, True),
    ('examples/LightNYCSubway/src/main/res/mipmap-xhdpi/ic_launcher_round.png', 96, True, 0.72, False),
    ('examples/LightNYCSubway/src/main/res/mipmap-xxhdpi/ic_launcher.png', 144, False, 0.72, False),
    ('examples/LightNYCSubway/src/main/res/mipmap-xxhdpi/ic_launcher_foreground.png', 144, False, 1.0, True),
    ('examples/LightNYCSubway/src/main/res/mipmap-xxhdpi/ic_launcher_round.png', 144, True, 0.72, False),
...
<!--
  BrightTransit launcher mark. One of the unified Bright* set: 108 canvas, 18..90
